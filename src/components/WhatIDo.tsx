        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Started building websites with JavaScript, now I craft them with
          ...
          >
            ...
            <div className="what-content-in">
              <h3>UI/UX DESIGN</h3>
              <h4>Description</h4>
             <p>Designing intuitive, user-friendly interfaces with focus on UX, accessibility, wireframes, and prototypes.</p>
